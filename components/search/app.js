      ...
      return (
        <Box className={classes.categoryFilters}>
          ...
          <Box>
            ...
            />
            {/* Removed as per Visual feedback to remove search box within Keywords list. Can use custom custom CustomRefinementList component in the future if search field will become required */}
