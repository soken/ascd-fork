...
export async function getStaticProps() {
  ...
  const booksData = await client.getEntries({
    ...
    select:
      'fields.title,fields.slug,fields.thumbnail,fields.authors,fields.bookVersions,fields.keywords,fields.topic,fields.description,fields.datePublished,fields.isbn,fields.featured,fields.premium,fields.quickRead',
    limit: 10,
  })
