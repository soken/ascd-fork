  ...
  const about = [
    {
      ...
      title: 'Webinars',
      body:
        'Our free webinar series brings education experts to you discussing topics like student engagement, classroom technology, and instructional strategies.',
      ctaLabel: 'Learn more',
      ctaLink: '/webinars',
    },
    {
      ...
      title: 'Symposiums',
      body:
        'Half-day symposiums that dive deep into the issues affecting educators. learn while engaging with peers and presenters in real time.',
      ctaLabel: 'Learn more',
    ...
    },
    {
      ...
      body:
        'Three-day virtual summit designed to inspire you and your leadership team and give you the skills and strategies you need to lead with confidence.',
      ctaLabel: 'Learn more',
    ...
    },
    {
      ...
      body:
        'This signature event brings experts and practitioners together to recharge and inspire you as we look ahead to a new school year and begin summer learning.',
      ctaLabel: 'Learn more',
  ...
  const learnmore = [
    {
      ...
      body:
        'Find out which events are actively seeking proposal submissions and sign up to be notified when they do. ',
      ctaLabel: 'Learn More',
    ...
    },
    {
      ...
      body:
        "Connect your company to today's education leaders and decision makers at our events.",
      ctaLabel: 'Learn More',
    ...
    },
    {
      ...
      body:
        'Attendees must be 18 years of age or older, unless advanced written authorization from ASCD is secured.',
      ctaLabel: 'Learn More',
