...
export default function Page({ page }) {
  ...
  const list = [
    ...
    {
      key: 2,
      title: 'Write an Article or Column',
      subtitle: "Write a piece for ASCD's official blog",
      description: (
        <>
          <TextStyle variant='h5'>What we look for</TextStyle>
          <TextStyle variant='body2'>
            In evaluating submissions for the blog, we look for articles that
            are timely and topical, addressing current issues and problems of
            practice in the field in a concise, conversational and lively
            manner. Articles should also be solution-oriented and grounded in
            authentic educational practice and evidence.
          </TextStyle>
          <Box my={5}>
            <TextStyle variant='h5'>
              Here are some examples of the types of online articles we publish:{' '}
            </TextStyle>
            ...
            <TextStyle variant='body2'>
              <ul>
                ...
                <li>
                  Pieces responding to current events and their implications for
          ...
          <CtaButton
            variant='outlined'
            color='primary'
            href='/write-for-the-blog'
            label='View Full Guidelines'
          />
        </>
      ),
      ctaLink: 'mailto:elsubmissions@ascd.org',
    },
    {
      key: 3,
    ...
    {
      key: 4,
      title: 'Write for ASCD Express',
      subtitle: 'Share your helpful tips and strategies with educators',
      description: (
        <>
          <TextStyle variant='h5'>What we look for</TextStyle>
          <TextStyle variant='body2'>
            We seek articles for each issue&apos;s topic from classroom
            teachers, leaders, researchers, and specialists. Submissions
            typically range from 600 to 1,000 words and have actionable
            takeaways—read it today, use it tomorrow. We welcome research-based
            strategies and solutions, examples from your own classroom, and
            advice about how to overcome specific challenges. Video and audio
            features are welcome and should be no longer than 5 minutes.
          </TextStyle>
          <Box my={5}>
            <TextStyle variant='h5'>How to Submit</TextStyle>

            <TextStyle variant='body2'>
              In your submission, please include your name, a brief professional
              bio, links to any sources, and the issue theme. Because of the
              volume of submissions we receive, we ask that you wait one month
              after the submission deadline to send any inquiries.
            </TextStyle>
          </Box>
          <CtaButton
            variant='outlined'
            color='primary'
            href='/write-for-express'
            label='View Full Guidelines'
          />
        </>
      ),
      ctaLink:
        'https://elmagazine.submittable.com/submit/171093/ascd-express-submissions',
    },
  ]
  ...
  const _renderActivateHubSpotForm = () => {
    ...
    return (
      <>
        <Divider />
        <Box my={[5, 10]} px={[1, 1, 3]} id="free-trial">
          <Grid
            container
            spacing={1}
              ...
              <Box pl={[0, 0, 5]}>
                <form className={classes.form} noValidate autoComplete='off'>
                  ...
                  <TextField
                    ...
                    fullWidth
                  >
                    <MenuItem key={0} value='United States'>
                      United States
                    </MenuItem>
                  </TextField>
                  <TextField
                  ...
                  <CtaButton
                    ...
                    onclick={() =>
                      console.log('start your free trial is clicked')
                    }
                  />
                </form>
              </Box>
  ...
  return (
    <Layout grey>
      ...
      {page.fields.slug == 'contact' && _renderHubSpotForm()}
    </Layout>
  )
}
...
export async function getStaticPaths() {
  ...
  return {
    paths: data.items.map((item) => ({
      params: {
        slug:
          item.fields.pageId == 'guidelines-for-writers'
            ? ['el', item.fields.slug]
            : [item.fields.slug],
...
export async function getStaticProps({ params }) {
  const data = await client.getEntries({
    content_type: 'page',
    'fields.slug': params.slug.length > 1 ? params.slug[1] : params.slug[0],
    include: 3,
  })
